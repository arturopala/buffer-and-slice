...
class ArrayBufferSpec extends AnyWordSpecCompat {
  ...
  "Buffer" should {
    ...
    "append value" in {
      ...
      buffer.asArray shouldBe Array("a", "b", "c", "d", "e", "f", "aa", "aaa", "aaaa", null, "foo")
    ...
    "remove value at an index" in {
      val buffer = new ArrayBuffer(Array("a", "b", "c"))
      buffer.remove(3).asArray shouldBe Array("a", "b", "c")
      buffer.remove(1).asArray shouldBe Array("a", "c")
      buffer.remove(0).asArray shouldBe Array("c")
      buffer.remove(0).asArray shouldBe Array.empty[String]
    }

    "remove values in the range" in {
      val buffer = new ArrayBuffer(Array("a", "b", "c", "e", "f", "g", "h"))
      buffer.removeRange(7, 15).asArray shouldBe Array("a", "b", "c", "e", "f", "g", "h")
      buffer.removeRange(1, 5).asArray shouldBe Array("a", "g", "h")
      buffer.removeRange(0, 2).asArray shouldBe Array("h")
      buffer.removeRange(0, 2).asArray shouldBe Array.empty[String]
    }

    "remove values matching the predicate" in {
      val buffer = Buffer(1, 2, 3, 4, 5, 6, 7, 8, 9)
      buffer.removeWhen(_ % 2 != 0).asArray shouldBe Array(2, 4, 6, 8)
      buffer.removeWhen(_ < 5).asArray shouldBe Array(6, 8)
      buffer.removeWhen(_ > 7).asArray shouldBe Array(6)
    }

    "shift values right" in {
      val buffer = new ArrayBuffer(Array("a", "b", "c"))
      buffer.shiftRight(1, 5).asArray shouldBe Array("a", "b", "c", null, null, null, "b", "c")
      buffer.length shouldBe 8
      buffer.shiftRight(7, 1).asArray shouldBe Array("a", "b", "c", null, null, null, "b", "c", "c")
      buffer.length shouldBe 9
      buffer.shiftRight(5, 2).asArray shouldBe Array("a", "b", "c", null, null, null, "b", null, "b", "c", "c")
      buffer.length shouldBe 11
      buffer.shiftRight(5, -2) // ignore negative distance
      buffer.asArray shouldBe Array("a", "b", "c", null, null, null, "b", null, "b", "c", "c")
      buffer.length shouldBe 11
    ...
    "shift values left" in {
      ...
      buffer.asArray shouldBe Array("a", "e", "b", "c")
      buffer.length shouldBe 4
      buffer.shiftLeft(2, 1)
      buffer.asArray shouldBe Array("a", "b", "c")
      buffer.length shouldBe 3
      buffer.shiftLeft(2, 2)
      buffer.asArray shouldBe Array("c")
      buffer.length shouldBe 1
      buffer.shiftLeft(0, 2)
      buffer.asArray shouldBe Array.empty[String]
    ...
    "move values in range to the right at a distance" in {
      ...
      buffer.moveRangeRight(2, 5, 2).asArray shouldBe Array("a", "b", "f", "g", "c", "d", "e", "h")
      buffer.moveRangeRight(0, 3, 3).asArray shouldBe Array("g", "c", "d", "a", "b", "f", "e", "h")
      buffer.moveRangeRight(1, 7, 2).asArray shouldBe Array("g", "h", null, "c", "d", "a", "b", "f", "e")
      buffer.moveRangeRight(15, 78, 25).asArray shouldBe Array("g", "h", null, "c", "d", "a", "b", "f", "e")
      buffer.moveRangeRight(1, 3, 5).asArray shouldBe Array("g", "c", "d", "a", "b", "f", "h", null, "e")
      buffer
        .moveRangeRight(1, 4, 10)
        .asArray shouldBe Array("g", "b", "f", "h", null, "e", null, null, null, null, null, "c", "d", "a")
    }

    "move values in range to the left at a distance" in {
      val buffer = new ArrayBuffer(Array("a", "b", "c", "d", "e", "f", "g", "h"))
      buffer.moveRangeLeft(3, 5, 2).asArray shouldBe Array("a", "d", "e", "b", "c", "f", "g", "h")
      buffer.moveRangeLeft(6, 10, 4).asArray shouldBe Array("a", "d", "g", "h", "e", "b", "c", "f")
      buffer.moveRangeLeft(2, 5, 2).asArray shouldBe Array("g", "h", "e", "a", "d", "b", "c", "f")
      buffer
        .moveRangeLeft(0, 5, 2)
        .asArray shouldBe Array("g", "h", "e", "a", "d", null, null, "b", "c", "f")
      buffer
        .moveRangeLeft(7, 12, 4)
        .asArray shouldBe Array("g", "h", "e", "b", "c", "f", "a", "d", null, null)
      buffer.trim(8).asArray shouldBe Array("g", "h", "e", "b", "c", "f", "a", "d")
      buffer
        .moveRangeLeft(5, 8, 5)
        .asArray shouldBe Array("f", "a", "d", "g", "h", "e", "b", "c")
      buffer
        .moveRangeLeft(5, 8, 4)
        .asArray shouldBe Array("f", "e", "b", "c", "a", "d", "g", "h")
      buffer
        .moveRangeLeft(5, 7, 3)
        .asArray shouldBe Array("f", "e", "d", "g", "b", "c", "a", "h")
      buffer
        .moveRangeLeft(7, 8, 7)
        .asArray shouldBe Array("h", "f", "e", "d", "g", "b", "c", "a")
    }

    "insert new value at index" in {
      Buffer.empty[String].insert(-1, "a").asArray shouldBe Array.empty[String]
      Buffer.empty[String].insert(0, "a").asArray shouldBe Array("a")
      Buffer.empty[String].insert(1, "a").asArray shouldBe Array(null, "a")
      Buffer.empty[String].insert(5, "c").asArray shouldBe Array(null, null, null, null, null, "c")
      Buffer("a").insert(-1, "c").asArray shouldBe Array("a")
      Buffer("a").insert(0, "c").asArray shouldBe Array("c", "a")
      Buffer("a").insert(1, "c").asArray shouldBe Array("a", "c")
      Buffer("a").insert(2, "c").asArray shouldBe Array("a", null, "c")
      Buffer("a", "b", "c").insert(-1, "x").asArray shouldBe Array("a", "b", "c")
      Buffer("a", "b", "c").insert(0, "x").asArray shouldBe Array("x", "a", "b", "c")
      Buffer("a", "b", "c").insert(1, "x").asArray shouldBe Array("a", "x", "b", "c")
      Buffer("a", "b", "c").insert(2, "x").asArray shouldBe Array("a", "b", "x", "c")
      Buffer("a", "b", "c").insert(3, "x").asArray shouldBe Array("a", "b", "c", "x")
      Buffer("a", "b", "c").insert(4, "x").asArray shouldBe Array("a", "b", "c", null, "x")
      Buffer("a", "b", "c").insert(5, "x").asArray shouldBe Array("a", "b", "c", null, null, "x")
    }
    ...
    "insert new array of values" in {
      ...
      buffer.asArray shouldBe Array("a", "d", "e", "b", "c")
      buffer.length shouldBe 5
      buffer.insertArray(0, 1, 1, Array("d", "e"))
      buffer.asArray shouldBe Array("e", "a", "d", "e", "b", "c")
      buffer.length shouldBe 6
      buffer.insertArray(0, 1, 0, Array("d", "e"))
      buffer.asArray shouldBe Array("e", "a", "d", "e", "b", "c")
      buffer.length shouldBe 6
      buffer.insertArray(5, 0, 2, Array("d", "e"))
      buffer.asArray shouldBe Array("e", "a", "d", "e", "b", "d", "e", "c")
      buffer.length shouldBe 8
      buffer.insertArray(10, 0, 5, Array("d", "e"))
      buffer.asArray shouldBe Array("e", "a", "d", "e", "b", "d", "e", "c", null, null, "d", "e")
    ...
    "insert a slice" in {
      val buffer = new ArrayBuffer(Array.empty[String])
      buffer.insertSlice(0, Slice("a", "b", "c")).asArray shouldBe Array("a", "b", "c")
      buffer.insertSlice(0, Slice("c", "b", "a")).asArray shouldBe Array("c", "b", "a", "a", "b", "c")
      buffer.insertSlice(3, Slice("e", "f")).asArray shouldBe Array("c", "b", "a", "e", "f", "a", "b", "c")
      buffer.insertSlice(5, Slice.empty[String]).asArray shouldBe Array("c", "b", "a", "e", "f", "a", "b", "c")
      buffer
        .insertSlice(10, Slice("e", "f", "g", "h"))
        .asArray shouldBe Array("c", "b", "a", "e", "f", "a", "b", "c", null, null, "e", "f", "g", "h")
    }
    ...
    "replace with a values from slice" in {
      val buffer = new ArrayBuffer(Array.empty[String])
      buffer.replaceFromSlice(3, Slice("e", "f", "g", "h")).asArray shouldBe Array(null, null, null, "e", "f", "g", "h")
      buffer.replaceFromSlice(0, Slice("e", "f", "g", "h")).asArray shouldBe Array("e", "f", "g", "h", "f", "g", "h")
      buffer.replaceFromSlice(5, Slice("a", "b", "c")).asArray shouldBe Array("e", "f", "g", "h", "f", "a", "b", "c")
    }
    ...
    "replace with values from indexed source" in {
      ...
      buffer.asArray shouldBe Array("a", "e", "f", "g")
      buffer.length shouldBe 4
      buffer.replaceValues(1, 0, 2, Array("d", "e"))
      buffer.asArray shouldBe Array("a", "d", "e", "g")
      buffer.length shouldBe 4
      buffer.replaceValues(0, 1, 1, Array("d", "e"))
      buffer.asArray shouldBe Array("e", "d", "e", "g")
      buffer.length shouldBe 4
      buffer.replaceValues(0, 1, 0, Array("d", "e"))
      buffer.asArray shouldBe Array("e", "d", "e", "g")
      buffer.length shouldBe 4
      buffer.replaceValues(5, 0, 2, Array("d", "e"))
      buffer.asArray shouldBe Array("e", "d", "e", "g", null, "d", "e")
      buffer.length shouldBe 7
      buffer.replaceValues(4, 0, 2, Array("d", "e"))
      buffer.asArray shouldBe Array("e", "d", "e", "g", "d", "e", "e")
      buffer.length shouldBe 7
    ...
    "insert new values from iterator" in {
      ...
      Buffer
        ...
        .asArray shouldBe Array("a", "b")
      Buffer
        .empty[String]
        .insertFromIterator(2, 2, Array("a", "b", "c").iterator)
        .asArray shouldBe Array(null, null, "a", "b")
      Buffer
        .empty[String]
        .insertFromIterator(2, 5, Array("a", "b", "c").iterator)
        .asArray shouldBe Array(null, null, "a", "b", "c")

      Buffer("x")
        .insertFromIterator(0, 1, Array("a", "b", "c").iterator)
        .asArray shouldBe Array("a", "x")
      Buffer("x")
        .insertFromIterator(1, 1, Array("a", "b", "c").iterator)
        .asArray shouldBe Array("x", "a")
      Buffer("x", "y", "z")
        .insertFromIterator(0, 3, Array("a", "b", "c").iterator)
        .asArray shouldBe Array("a", "b", "c", "x", "y", "z")
      Buffer("x", "y", "z")
        .insertFromIterator(1, 2, Array("a", "b", "c").iterator)
        .asArray shouldBe Array("x", "a", "b", "y", "z")
      Buffer("x", "y", "z")
        .insertFromIterator(5, 2, Array("a", "b", "c").iterator)
        .asArray shouldBe Array("x", "y", "z", null, null, "a", "b")
    }
    ...
    "inserts new values from iterator without specifying length" in {
      Buffer
        ...
        .asArray shouldBe Array.empty[String]
      Buffer
        .empty[String]
        .insertFromIterator(0, Array("a").iterator)
        .asArray shouldBe Array("a")
      Buffer
        .empty[String]
      ...
      Buffer
        ...
        .asArray shouldBe Array(null, null, null, "a", "b", "c")
      Buffer
        .empty[String]
        .insertFromIterator(1, Iterator.continually("x").take(10))
        .asArray shouldBe Array(null, "x", "x", "x", "x", "x", "x", "x", "x", "x", "x")
    }
    ...
    "insert new values from iterator in the reverse order" in {
      ...
      Buffer
        ...
        .asArray shouldBe Array("b", "a")
      Buffer
        .empty[String]
        .insertFromIteratorReverse(2, 2, Array("a", "b", "c").iterator)
        .asArray shouldBe Array(null, null, "b", "a")
      Buffer
        .empty[String]
        .insertFromIteratorReverse(2, 5, Array("a", "b", "c").iterator)
        .asArray shouldBe Array(null, null, "c", "b", "a")
      ...
      Buffer("x", "y", "z")
        .insertFromIteratorReverse(0, 3, Array("a", "b", "c").iterator)
        .asArray shouldBe Array("c", "b", "a", "x", "y", "z")
      Buffer("x", "y", "z")
        .insertFromIteratorReverse(1, 2, Array("a", "b", "c").iterator)
        .asArray shouldBe Array("x", "b", "a", "y", "z")
      Buffer("x", "y", "z")
        .insertFromIteratorReverse(5, 2, Array("a", "b", "c").iterator)
        .asArray shouldBe Array("x", "y", "z", null, null, "b", "a")
    }
    ...
    "insert new values from iterator in the reverse order without specifying length" in {
      ...
      Buffer
        ...
        .asArray shouldBe Array(null, null, null, "c", "b", "a")
      Buffer
        .empty[String]
        .insertFromIteratorReverse(3, Array("a", "b", "c", "d", "e", "f", "g", "h").iterator)
        .asArray shouldBe Array(null, null, null, "h", "g", "f", "e", "d", "c", "b", "a")
      Buffer
        .empty[String]
    ...
    "replace with values from iterator" in {
      ...
      buffer.asArray shouldBe Array("e", "d", "e", "d", "e", "f", "e")
      buffer.length shouldBe 7
    ...
    "replace with values from iterator in the reverse order" in {
      Buffer
        ...
        .asArray shouldBe Array(null, "c", "b", "a")
      Buffer
        .empty[String]
        .replaceFromIteratorReverse(0, 7, Array("a", "b", "c").iterator)
        .asArray shouldBe Array(null, null, null, null, "c", "b", "a")
      Buffer
        .empty[String]
        .replaceFromIteratorReverse(1, 2, Array("a", "b", "c").iterator)
        .asArray shouldBe Array(null, "b", "a")
      Buffer
        .empty[String]
      ...
      Buffer("x", "y", "z")
        .replaceFromIteratorReverse(1, 2, Array("a", "b", "c").iterator)
        .asArray shouldBe Array("x", "b", "a")
      Buffer("x", "y", "z")
        .replaceFromIteratorReverse(1, 3, Array("a", "b", "c").iterator)
        .asArray shouldBe Array("x", "c", "b", "a")
      Buffer("x", "y", "z")
        .replaceFromIteratorReverse(1, 4, Array("a", "b", "c").iterator)
        .asArray shouldBe Array("x", "y", "c", "b", "a")
      Buffer("x", "y", "z")
        .replaceFromIteratorReverse(1, 7, Array("a", "b", "c").iterator)
        .asArray shouldBe Array("x", "y", "z", null, null, "c", "b", "a")
      Buffer("x", "y", "z")
    ...
    "append an array" in {
      ...
      buffer.appendArray(Array("a", "b", "c"))
      buffer.length shouldBe 6
      buffer.asArray shouldBe Array("a", "b", "c", "a", "b", "c")
      buffer.appendArray(Array("d", "e"))
      buffer.length shouldBe 8
      buffer.asArray shouldBe Array("a", "b", "c", "a", "b", "c", "d", "e")
    ...
    "append a slice" in {
      val buffer = new ArrayBuffer(Array.empty[String])
      buffer.appendSlice(Slice.empty[String]).asArray shouldBe Array.empty[String]
      buffer.appendSlice(Slice("a", "b", "c")).asArray shouldBe Array("a", "b", "c")
      buffer.appendSlice(Slice("a", "b", "c")).asArray shouldBe Array("a", "b", "c", "a", "b", "c")
      buffer.appendSlice(Slice("e")).asArray shouldBe Array("a", "b", "c", "a", "b", "c", "e")
      buffer.appendSlice(Slice("e", "f", "g")).asArray shouldBe Array("a", "b", "c", "a", "b", "c", "e", "e", "f", "g")
      buffer.appendSlice(Slice.empty[String]).asArray shouldBe Array("a", "b", "c", "a", "b", "c", "e", "e", "f", "g")
    }
    ...
    "append values from iterator" in {
      ...
      Buffer
        ...
        .asArray shouldBe Array.fill(60)("a")
      Buffer
        .empty[String]
        .appendFromIterator(Iterator.fill(1024)("x"))
        .asArray shouldBe Array.fill(1024)("x")
    }
    ...
    "swap two values" in {
      val buffer = new ArrayBuffer(Array("a", "b", "c"))
      buffer.swap(2, 2).asArray shouldBe Array("a", "b", "c")
      buffer.swap(0, 2).asArray shouldBe Array("c", "b", "a")
      buffer.swap(0, 1).asArray shouldBe Array("b", "c", "a")
      buffer.swap(2, 1).asArray shouldBe Array("b", "a", "c")
      buffer.swap(2, 3).asArray shouldBe Array("b", "a", "c")
      buffer.swap(-1, 1).asArray shouldBe Array("b", "a", "c")
      buffer.swap(-1, -5).asArray shouldBe Array("b", "a", "c")
    }

    "swap two ranges of values" in {
      val buffer = new ArrayBuffer(Array("a", "b", "c", "d", "e", "f", "g", "h"))
      buffer.swapRange(0, 5, 2).asArray shouldBe Array("f", "g", "c", "d", "e", "a", "b", "h")
      buffer.swapRange(0, 3, 5).asArray shouldBe Array("d", "e", "a", "b", "h", "c", "d", "e")
      buffer.swapRange(-2, 3, 5).asArray shouldBe Array("d", "e", "a", "b", "h", "c", "d", "e")
      buffer.swapRange(3, -3, 5).asArray shouldBe Array("d", "e", "a", "b", "h", "c", "d", "e")
      buffer.swapRange(3, 3, 5).asArray shouldBe Array("d", "e", "a", "b", "h", "c", "d", "e")
      buffer.swapRange(3, 4, 0).asArray shouldBe Array("d", "e", "a", "b", "h", "c", "d", "e")
      buffer.swapRange(4, 1, 3).asArray shouldBe Array("d", "h", "c", "d", "e", "a", "b", "e")
    }

    "have a tail" in {
      val buffer = new ArrayBuffer(Array("a", "b", "c", "d", "e", "f", "g", "h"))
      buffer.tail.asArray shouldBe Array("a", "b", "c", "d", "e", "f", "g")
      buffer.tail.asArray shouldBe Array("a", "b", "c", "d", "e", "f")
      buffer.tail.asArray shouldBe Array("a", "b", "c", "d", "e")
      buffer.tail.asArray shouldBe Array("a", "b", "c", "d")
      buffer.tail.asArray shouldBe Array("a", "b", "c")
      buffer.tail.asArray shouldBe Array("a", "b")
      buffer.tail.asArray shouldBe Array("a")
    ...
    "have a copy" in {
      val buffer = new ArrayBuffer(Array("a", "b", "c"))
      buffer.copy.append("d").asArray shouldBe Array("a", "b", "c", "d")
      buffer.copy.append("e").asArray shouldBe Array("a", "b", "c", "e")
      buffer.asArray shouldBe Array("a", "b", "c")
    }

    "have an emptyCopy" in {
      val buffer = new ArrayBuffer(Array("a", "b", "c"))
      buffer.emptyCopy.append("d").asArray shouldBe Array("d")
      buffer.emptyCopy.append("e").asArray shouldBe Array("e")
      buffer.asArray shouldBe Array("a", "b", "c")
    }
    ...
    "have an init" in {
      Buffer.empty[String].init.asArray shouldBe Array.empty[String]
      Buffer.empty[Int].init.asArray shouldBe Array.empty[Int]
      Buffer(1).init.asArray shouldBe Array.empty[Int]
      Buffer("a", "b").init.asArray shouldBe Array("b")
      Buffer("a", "b", "c").init.asArray shouldBe Array("b", "c")
      Buffer("a", "b", "c", "d").init.asArray shouldBe Array("b", "c", "d")
      Buffer("a", "c").init.asArray shouldBe Array("c")
      Buffer(1, 2).init.asArray shouldBe Array(2)
      Buffer(13, 1).init.asArray shouldBe Array(1)
      Buffer(13, 1, 17, 23).init.asArray shouldBe Array(1, 17, 23)
      Buffer(13, 17, 1, 23).init.asArray shouldBe Array(17, 1, 23)
    }
